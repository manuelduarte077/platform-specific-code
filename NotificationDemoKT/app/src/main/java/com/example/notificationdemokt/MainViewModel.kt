...
import com.example.notificationdemokt.di.MainNotificationCompatBuilder
import com.example.notificationdemokt.di.SecondNotificationCompatBuilder
...
class MainViewModel @Inject constructor(
  ...
  fun updateSimpleNotification() {
    notificationManager.notify(2, notificationBuilder.setContentTitle("NEW TITLE").build())
  }
